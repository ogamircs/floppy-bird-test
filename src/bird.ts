import { Position, Dimensions, BoundingBox, GameConfig } from './types.js';
...
export class Bird {
    ...
    private readonly color: string = '#f4d03f';
    private readonly eyeColor: string = '#fff';
    private readonly pupilColor: string = '#000';
    private readonly beakColor: string = '#e67e22';
    private rotation: number = 0;

    constructor(config: GameConfig, startX: number = 100, startY: number = 250) {
        this.config = config;
     ...
     */
    public reset(startY: number = 250): void {
